...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"Acceleration1", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration2", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration3", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration4", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration5", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration6", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"Acceleration7", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
